...
export default function LandingScreen() {
  ...
  return (
    ...
    >
      ...
      >
        {[
          { label: "LEVEL", value: "21", color: "cyan" as const },
          ...
          >
            <div className="glass-panel-purple clip-corner px-8 py-4 md:px-14 md:py-6 relative overflow-hidden">
              ...
              <div className="absolute inset-0 overflow-hidden">
                <div className="absolute inset-y-0 -left-1/3 w-1/3 bg-gradient-to-r from-transparent via-pink-400/30 to-transparent skew-x-12 group-hover:translate-x-[300%] transition-transform duration-700" />
              </div>
              <div
            ...
            {/* Outer glow ring */}
            <div className="absolute -inset-2 border border-pink-500/30 clip-corner pointer-events-none group-hover:border-pink-400/70 transition-colors" />
          </motion.button>
        )}
      </AnimatePresence>
